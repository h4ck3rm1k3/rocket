...
mains: rkt6 stage1 ipam  veth bridge

helper : Godeps/_workspace/src/github.com/cznic/ql/helper.go Godeps/_workspace/src/github.com/cznic/ql.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/ql/helper.go

rkt6: ./rkt/gc.go ./rkt/metadatasvc.go ./rkt/version.go ./rkt/list.go  ./rkt/fetch.go ./rkt/rkt.go ./rkt/trust.go ./rkt/uuid.go ./rkt/status.go ./rkt/enter.go ./rkt/doc.go ./rkt/containers.go ./rkt/help.go ./rkt/run.go \
	Godeps/_workspace/src/github.com/gorilla/mux.o networking/util.o ./networking/ipam.o networking/ipam/static/backend/disk.o  networking/net.o  networking/ipam/static/backend.o Godeps/_workspace/src/github.com/vishvananda/netlink.o Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o Godeps/_workspace/src/github.com/appc/spec/schema/types.o ./networking/ipam/static/backend/disk.o  Godeps/_workspace/src/github.com/coreos/go-semver/semver.o Godeps/_workspace/src/github.com/appc/spec/schema.o ./common.o ./cas.o Godeps/_workspace/src/github.com/appc/spec/discovery.o ./pkg/keystore.o Godeps/_workspace/src/golang.org/x/crypto/openpgp.o stage0.o Godeps/_workspace/src/github.com/cznic/bufs.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/errors.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/s2k.o Godeps/_workspace/src/golang.org/x/net/html.o Godeps/_workspace/src/github.com/mitchellh/ioprogress.o Godeps/_workspace/src/github.com/cznic/zappy.o Godeps/_workspace/src/github.com/cznic/fileutil.o Godeps/_workspace/src/github.com/cznic/mathutil.o Godeps/_workspace/src/golang.org/x/crypto/cast5.o Godeps/_workspace/src/github.com/peterbourgon/diskv.o Godeps/_workspace/src/github.com/cznic/exp/lldb.o Godeps/_workspace/src/github.com/appc/spec/pkg/tarheader.o Godeps/_workspace/src/code.google.com/p/go-uuid/uuid.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet.o ./pkg/aci.o Godeps/_workspace/src/github.com/gorilla/context.o Godeps/_workspace/src/github.com/cznic/ql.o Godeps/_workspace/src/github.com/appc/spec/aci.o Godeps/_workspace/src/github.com/cznic/ql/driver.o ./cas.o ./pkg/tar.o Godeps/_workspace/src/github.com/appc/docker2aci/lib.o Godeps/_workspace/src/golang.org/x/net/html/atom.o Godeps/_workspace/src/github.com/petar/GoLLRB/llrb.o Godeps/_workspace/src/github.com/cznic/sortutil.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/elgamal.o Godeps/_workspace/src/github.com/cznic/strutil.o Godeps/_workspace/src/github.com/appc/docker2aci/tarball.o   ./pkg/lock.o Godeps/_workspace/src/github.com/camlistore/lock.o
 # Godeps/_workspace/src/github.com/camlistore/lock.o
	$(GCCGO) -L . -I .  -g -o $@ $^ 

stage1: ./stage1/init/path.go ./stage1/init/init.go  ./stage1/init/registration.go ./stage1/init/container.go
	$(GCCGO) -L . -I .  -g -o $@ $^

#ql: Godeps/_workspace/src/github.com/cznic/ql/ql/main.go
#	$(GCCGO) -L . -I . -c -g -o $@ $^

ipam: ./networking/ipam/static/main.go  ./networking/ipam/static/allocator.go ./networking/ipam/static/config.go  \
	networking/util.o ./networking/ipam.o networking/ipam/static/backend/disk.o  networking/net.o  networking/ipam/static/backend.o Godeps/_workspace/src/github.com/vishvananda/netlink.o Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o Godeps/_workspace/src/github.com/appc/spec/schema/types.o ./networking/ipam/static/backend/disk.o ./pkg/lock.o Godeps/_workspace/src/github.com/coreos/go-semver/semver.o
	$(GCCGO) -L . -I .  -g -o $@  $^


./networking/ipam.o: ./networking/ipam/ipam.go networking/util.o Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o Godeps/_workspace/src/github.com/vishvananda/netlink.o Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o Godeps/_workspace/src/github.com/appc/spec/schema/types.o Godeps/_workspace/src/github.com/coreos/go-semver/semver.o
	$(GCCGO) -L . -I . -c -g -o $@ ./networking/ipam/ipam.go

veth: ./networking/net/veth/veth.go \
	Godeps/_workspace/src/github.com/vishvananda/netlink.o \
	networking/ipam.o \
	networking/net.o \
	networking/util.o \
	networking/ipam/static/backend/disk.o  \
	networking/ipam/static/backend.o \
	Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o \
	Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o \
	Godeps/_workspace/src/github.com/appc/spec/schema/types.o \
	networking/ipam/static/backend/disk.o \
	pkg/lock.o \
	Godeps/_workspace/src/github.com/coreos/go-semver/semver.o
	$(GCCGO) -L . -I .  -g -o $@ $^

bridge: ./networking/net/bridge/bridge.go Godeps/_workspace/src/github.com/vishvananda/netlink.o networking/ipam.o networking/net.o networking/util.o
	$(GCCGO) -L . -I .  -g -o $@ ./networking/net/bridge/bridge.go
...
Godeps/_workspace/src/github.com/cznic/fileutil/hdb.o: Godeps/_workspace/src/github.com/cznic/fileutil/hdb/hdb.go  Godeps/_workspace/src/github.com/cznic/fileutil/hdb/test_deps.go Godeps/_workspace/src/github.com/cznic/fileutil/falloc.o Godeps/_workspace/src/github.com/cznic/fileutil.o Godeps/_workspace/src/github.com/cznic/fileutil/storage.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/fileutil/hdb/hdb.go  Godeps/_workspace/src/github.com/cznic/fileutil/hdb/test_deps.go
...
Godeps/_workspace/src/github.com/cznic/ql/driver.o:  Godeps/_workspace/src/github.com/cznic/ql/driver/driver.go Godeps/_workspace/src/github.com/cznic/ql.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/ql/driver/driver.go
...
./cas.o: ./cas/db.go ./cas/remote.go ./cas/schema.go ./cas/cas.go ./cas/aciinfo.go  ./cas/utils.go  \
	Godeps/_workspace/src/github.com/appc/docker2aci/lib.o \
	Godeps/_workspace/src/github.com/peterbourgon/diskv.o 
	$(GCCGO) -L . -I . -c -g -o $@ ./cas/db.go ./cas/remote.go ./cas/schema.go ./cas/cas.go ./cas/aciinfo.go  ./cas/utils.go
...
Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet.o:  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/public_key.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/private_key.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/userid.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/symmetrically_encrypted.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/literal.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/compressed.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/config.go    Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/one_pass_signature.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/encrypted_key.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/symmetric_key_encrypted.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/signature_v3.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/packet.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/signature.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/ocfb.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/opaque.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/public_key_v3.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/userattribute.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/reader.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/elgamal.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/s2k.o Godeps/_workspace/src/golang.org/x/crypto/cast5.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/public_key.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/private_key.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/userid.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/symmetrically_encrypted.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/literal.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/compressed.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/config.go    Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/one_pass_signature.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/encrypted_key.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/symmetric_key_encrypted.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/signature_v3.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/packet.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/signature.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/ocfb.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/opaque.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/public_key_v3.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/userattribute.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet/reader.go
...
Godeps/_workspace/src/github.com/cznic/fileutil/falloc.o: Godeps/_workspace/src/github.com/cznic/fileutil/falloc/test_deps.go  Godeps/_workspace/src/github.com/cznic/fileutil/falloc/falloc.go Godeps/_workspace/src/github.com/cznic/fileutil/falloc/error.go Godeps/_workspace/src/github.com/cznic/fileutil/falloc/docs.go Godeps/_workspace/src/github.com/cznic/fileutil.o Godeps/_workspace/src/github.com/cznic/fileutil/storage.o 
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/fileutil/falloc/test_deps.go  Godeps/_workspace/src/github.com/cznic/fileutil/falloc/falloc.go Godeps/_workspace/src/github.com/cznic/fileutil/falloc/error.go Godeps/_workspace/src/github.com/cznic/fileutil/falloc/docs.go
...
#Godeps/_workspace/src/golang.org/x/net/html/atom/gen.go
	$(GCCGO) -L . -I . -c -g -o $@ $^
./common.o: ./common/common.go Godeps/_workspace/src/github.com/appc/spec/aci.o
	$(GCCGO) -L . -I . -c -g -o $@ ./common/common.go

./networking/util.o: ./networking/util/route.go ./networking/util/cidr.go ./networking/util/skel.go ./networking/util/link.go ./networking/util/setns.go ./networking/util/ipmasq.go  Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o  Godeps/_workspace/src/code.google.com/p/go-uuid/uuid.o Godeps/_workspace/src/github.com/appc/spec/schema/types.o
	$(GCCGO) -L . -I . -c -g -o $@ ./networking/util/route.go ./networking/util/cidr.go ./networking/util/skel.go ./networking/util/link.go ./networking/util/setns.go ./networking/util/ipmasq.go 
...
Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor.o: Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor/encode.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor/armor.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/errors.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor/encode.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor/armor.go

Godeps/_workspace/src/github.com/cznic/exp/lldb.o:     Godeps/_workspace/src/github.com/cznic/exp/lldb/memfiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/gb.go Godeps/_workspace/src/github.com/cznic/exp/lldb/simplefilefiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/xact.go   Godeps/_workspace/src/github.com/cznic/exp/lldb/osfiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/2pc.go Godeps/_workspace/src/github.com/cznic/exp/lldb/lldb.go  Godeps/_workspace/src/github.com/cznic/exp/lldb/errors.go Godeps/_workspace/src/github.com/cznic/exp/lldb/2pc_docs.go Godeps/_workspace/src/github.com/cznic/exp/lldb/falloc.go  Godeps/_workspace/src/github.com/cznic/exp/lldb/filer.go Godeps/_workspace/src/github.com/cznic/exp/lldb/btree.go Godeps/_workspace/src/github.com/cznic/fileutil.o Godeps/_workspace/src/github.com/cznic/mathutil.o  Godeps/_workspace/src/github.com/cznic/bufs.o Godeps/_workspace/src/github.com/cznic/sortutil.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/exp/lldb/memfiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/gb.go Godeps/_workspace/src/github.com/cznic/exp/lldb/simplefilefiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/xact.go   Godeps/_workspace/src/github.com/cznic/exp/lldb/osfiler.go Godeps/_workspace/src/github.com/cznic/exp/lldb/2pc.go Godeps/_workspace/src/github.com/cznic/exp/lldb/lldb.go  Godeps/_workspace/src/github.com/cznic/exp/lldb/errors.go Godeps/_workspace/src/github.com/cznic/exp/lldb/2pc_docs.go Godeps/_workspace/src/github.com/cznic/exp/lldb/falloc.go  Godeps/_workspace/src/github.com/cznic/exp/lldb/filer.go Godeps/_workspace/src/github.com/cznic/exp/lldb/btree.go
...
./pkg/keystore.o:  ./pkg/keystore/keystore.go ./pkg/keystore/keystoretest.o
	$(GCCGO) -L . -I . -c -g -o $@ ./pkg/keystore/keystore.go
...
Godeps/_workspace/src/github.com/cznic/fileutil.o: Godeps/_workspace/src/github.com/cznic/fileutil/test_deps.go  Godeps/_workspace/src/github.com/cznic/fileutil/fileutil_linux.go  Godeps/_workspace/src/github.com/cznic/fileutil/fileutil.go 
	$(GCCGO) -L . -I . -c -g -o $@ $^
...
Godeps/_workspace/src/github.com/vishvananda/netlink.o: Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_state.go Godeps/_workspace/src/github.com/vishvananda/netlink/neigh_linux.go    Godeps/_workspace/src/github.com/vishvananda/netlink/addr.go Godeps/_workspace/src/github.com/vishvananda/netlink/route.go Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_policy_linux.go   Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_policy.go   Godeps/_workspace/src/github.com/vishvananda/netlink/neigh.go Godeps/_workspace/src/github.com/vishvananda/netlink/link_linux.go  Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm.go Godeps/_workspace/src/github.com/vishvananda/netlink/route_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/netlink.go Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_state_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/addr_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/link.go Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_state.go Godeps/_workspace/src/github.com/vishvananda/netlink/neigh_linux.go    Godeps/_workspace/src/github.com/vishvananda/netlink/addr.go Godeps/_workspace/src/github.com/vishvananda/netlink/route.go Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_policy_linux.go   Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_policy.go   Godeps/_workspace/src/github.com/vishvananda/netlink/neigh.go Godeps/_workspace/src/github.com/vishvananda/netlink/link_linux.go  Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm.go Godeps/_workspace/src/github.com/vishvananda/netlink/route_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/netlink.go Godeps/_workspace/src/github.com/vishvananda/netlink/xfrm_state_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/addr_linux.go Godeps/_workspace/src/github.com/vishvananda/netlink/link.go
...
Godeps/_workspace/src/github.com/appc/spec/aci.o: Godeps/_workspace/src/github.com/appc/spec/aci/writer.go Godeps/_workspace/src/github.com/appc/spec/aci/file.go Godeps/_workspace/src/github.com/appc/spec/aci/build.go Godeps/_workspace/src/github.com/appc/spec/aci/doc.go  Godeps/_workspace/src/github.com/appc/spec/aci/layout.go Godeps/_workspace/src/github.com/appc/spec/schema.o Godeps/_workspace/src/github.com/appc/spec/pkg/tarheader.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/appc/spec/aci/writer.go Godeps/_workspace/src/github.com/appc/spec/aci/file.go Godeps/_workspace/src/github.com/appc/spec/aci/build.go Godeps/_workspace/src/github.com/appc/spec/aci/doc.go  Godeps/_workspace/src/github.com/appc/spec/aci/layout.go
...
Godeps/_workspace/src/github.com/appc/spec/schema.o: Godeps/_workspace/src/github.com/appc/spec/schema/version.go  Godeps/_workspace/src/github.com/appc/spec/schema/kind.go Godeps/_workspace/src/github.com/appc/spec/schema/doc.go Godeps/_workspace/src/github.com/appc/spec/schema/image.go Godeps/_workspace/src/github.com/appc/spec/schema/container.go  Godeps/_workspace/src/github.com/appc/spec/schema/types.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/appc/spec/schema/version.go  Godeps/_workspace/src/github.com/appc/spec/schema/kind.go Godeps/_workspace/src/github.com/appc/spec/schema/doc.go Godeps/_workspace/src/github.com/appc/spec/schema/image.go Godeps/_workspace/src/github.com/appc/spec/schema/container.go
...
Godeps/_workspace/src/github.com/cznic/ql.o: Godeps/_workspace/src/github.com/cznic/ql/httpfs.go  Godeps/_workspace/src/github.com/cznic/ql/coerce.go Godeps/_workspace/src/github.com/cznic/ql/scanner.go Godeps/_workspace/src/github.com/cznic/ql/introspection.go  Godeps/_workspace/src/github.com/cznic/ql/expr.go   Godeps/_workspace/src/github.com/cznic/ql/storage.go Godeps/_workspace/src/github.com/cznic/ql/ql.go  Godeps/_workspace/src/github.com/cznic/ql/parser.go  Godeps/_workspace/src/github.com/cznic/ql/file.go Godeps/_workspace/src/github.com/cznic/ql/builtin.go Godeps/_workspace/src/github.com/cznic/ql/doc.go Godeps/_workspace/src/github.com/cznic/ql/etc.go Godeps/_workspace/src/github.com/cznic/ql/stmt.go  Godeps/_workspace/src/github.com/cznic/ql/driver.go Godeps/_workspace/src/github.com/cznic/ql/blob.go Godeps/_workspace/src/github.com/cznic/ql/errors.go \
	Godeps/_workspace/src/github.com/camlistore/lock.o \
	Godeps/_workspace/src/github.com/cznic/strutil.o \
	Godeps/_workspace/src/github.com/mitchellh/ioprogress.o	

	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/cznic/ql/httpfs.go  Godeps/_workspace/src/github.com/cznic/ql/coerce.go Godeps/_workspace/src/github.com/cznic/ql/scanner.go Godeps/_workspace/src/github.com/cznic/ql/introspection.go  Godeps/_workspace/src/github.com/cznic/ql/expr.go   Godeps/_workspace/src/github.com/cznic/ql/storage.go Godeps/_workspace/src/github.com/cznic/ql/ql.go  Godeps/_workspace/src/github.com/cznic/ql/parser.go  Godeps/_workspace/src/github.com/cznic/ql/file.go Godeps/_workspace/src/github.com/cznic/ql/builtin.go Godeps/_workspace/src/github.com/cznic/ql/doc.go Godeps/_workspace/src/github.com/cznic/ql/etc.go Godeps/_workspace/src/github.com/cznic/ql/stmt.go  Godeps/_workspace/src/github.com/cznic/ql/driver.go Godeps/_workspace/src/github.com/cznic/ql/blob.go Godeps/_workspace/src/github.com/cznic/ql/errors.go 
...
Godeps/_workspace/src/golang.org/x/crypto/openpgp.o: Godeps/_workspace/src/golang.org/x/crypto/openpgp/write.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/read.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/canonical_text.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/keys.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/errors.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/golang.org/x/crypto/openpgp/write.go   Godeps/_workspace/src/golang.org/x/crypto/openpgp/read.go  Godeps/_workspace/src/golang.org/x/crypto/openpgp/canonical_text.go Godeps/_workspace/src/golang.org/x/crypto/openpgp/keys.go
...
./networking/ipam/static/backend/disk.o: ./networking/ipam/static/backend/disk/backend.go ./pkg/lock.o 
	$(GCCGO) -L . -I . -c -g -o $@ ./networking/ipam/static/backend/disk/backend.go

./pkg/keystore/keystoretest.o: ./pkg/keystore/keystoretest/opengpg.go  ./pkg/keystore/keystoretest/keymap.go Godeps/_workspace/src/golang.org/x/crypto/openpgp.o
	$(GCCGO) -L . -I . -c -g -o $@ ./pkg/keystore/keystoretest/opengpg.go  ./pkg/keystore/keystoretest/keymap.go

keygen : ./pkg/keystore/keystoretest/keygen.go ./pkg/keystore/keystoretest.o
	$(GCCGO) -L . -I . -c -g -o $@ $^
...
Godeps/_workspace/src/github.com/appc/spec/schema/types.o: Godeps/_workspace/src/github.com/appc/spec/schema/types/errors.go Godeps/_workspace/src/github.com/appc/spec/schema/types/volume.go Godeps/_workspace/src/github.com/appc/spec/schema/types/app.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/labels.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/annotations.go Godeps/_workspace/src/github.com/appc/spec/schema/types/exec.go Godeps/_workspace/src/github.com/appc/spec/schema/types/dependencies.go   Godeps/_workspace/src/github.com/appc/spec/schema/types/hash.go Godeps/_workspace/src/github.com/appc/spec/schema/types/doc.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/acname.go Godeps/_workspace/src/github.com/appc/spec/schema/types/semver.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/ackind.go Godeps/_workspace/src/github.com/appc/spec/schema/types/port.go Godeps/_workspace/src/github.com/appc/spec/schema/types/isolator.go   Godeps/_workspace/src/github.com/appc/spec/schema/types/environment.go Godeps/_workspace/src/github.com/appc/spec/schema/types/event_handler.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/mountpoint.go     Godeps/_workspace/src/github.com/appc/spec/schema/types/uuid.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/date.go Godeps/_workspace/src/github.com/appc/spec/schema/types/url.go Godeps/_workspace/src/github.com/coreos/go-semver/semver.o
	$(GCCGO) -L . -I . -c -g -o $@ Godeps/_workspace/src/github.com/appc/spec/schema/types/errors.go Godeps/_workspace/src/github.com/appc/spec/schema/types/volume.go Godeps/_workspace/src/github.com/appc/spec/schema/types/app.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/labels.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/annotations.go Godeps/_workspace/src/github.com/appc/spec/schema/types/exec.go Godeps/_workspace/src/github.com/appc/spec/schema/types/dependencies.go   Godeps/_workspace/src/github.com/appc/spec/schema/types/hash.go Godeps/_workspace/src/github.com/appc/spec/schema/types/doc.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/acname.go Godeps/_workspace/src/github.com/appc/spec/schema/types/semver.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/ackind.go Godeps/_workspace/src/github.com/appc/spec/schema/types/port.go Godeps/_workspace/src/github.com/appc/spec/schema/types/isolator.go   Godeps/_workspace/src/github.com/appc/spec/schema/types/environment.go Godeps/_workspace/src/github.com/appc/spec/schema/types/event_handler.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/mountpoint.go     Godeps/_workspace/src/github.com/appc/spec/schema/types/uuid.go  Godeps/_workspace/src/github.com/appc/spec/schema/types/date.go Godeps/_workspace/src/github.com/appc/spec/schema/types/url.go
...
all_pkgs:./pkg/aci.o Godeps/_workspace/src/github.com/camlistore/lock.o  Godeps/_workspace/src/golang.org/x/crypto/openpgp/errors.o Godeps/_workspace/src/github.com/cznic/sortutil.o Godeps/_workspace/src/github.com/cznic/mathutil/example3.o Godeps/_workspace/src/github.com/cznic/fileutil/hdb.o Godeps/_workspace/src/github.com/appc/docker2aci/lib.o ./pkg/tar.o Godeps/_workspace/src/github.com/peterbourgon/diskv/examples/content-addressable-store.o Godeps/_workspace/src/github.com/cznic/fileutil/storage.o \
	Godeps/_workspace/src/github.com/mitchellh/ioprogress.o \
	 ./networking/net.o Godeps/_workspace/src/github.com/vishvananda/netlink/nl.o  Godeps/_workspace/src/github.com/appc/spec/discovery.o Godeps/_workspace/src/github.com/cznic/ql/driver.o ./networking/ipam/static.o Godeps/_workspace/src/github.com/cznic/mathutil/example2.o Godeps/_workspace/src/github.com/gorilla/mux.o Godeps/_workspace/src/github.com/appc/spec/actool.o Godeps/_workspace/src/github.com/peterbourgon/diskv.o ./networking/ipam/static/backend.o Godeps/_workspace/src/github.com/cznic/bufs.o ./stage0.o ./cas.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/packet.o ./pkg/lock.o Godeps/_workspace/src/github.com/coreos/go-systemd/unit.o Godeps/_workspace/src/github.com/cznic/strutil.o Godeps/_workspace/src/github.com/cznic/fileutil/falloc.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/elgamal.o ./networking/ipam.o ./stage1.o ./version.o Godeps/_workspace/src/github.com/appc/spec/pkg/tarheader.o Godeps/_workspace/src/github.com/cznic/zappy.o Godeps/_workspace/src/golang.org/x/net/html/atom.o ./common.o  Godeps/_workspace/src/golang.org/x/crypto/openpgp/clearsign.o Godeps/_workspace/src/github.com/cznic/mathutil/ff.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/armor.o Godeps/_workspace/src/github.com/cznic/exp/lldb.o Godeps/_workspace/src/github.com/petar/GoLLRB/llrb.o  ./pkg/keystore.o Godeps/_workspace/src/golang.org/x/crypto/cast5.o ./networking.o Godeps/_workspace/src/github.com/cznic/fileutil.o Godeps/_workspace/src/github.com/coreos/go-semver/semver.o  Godeps/_workspace/src/github.com/vishvananda/netlink.o Godeps/_workspace/src/github.com/coreos/go-iptables/iptables.o Godeps/_workspace/src/golang.org/x/crypto/openpgp/s2k.o Godeps/_workspace/src/github.com/gorilla/context.o Godeps/_workspace/src/github.com/appc/spec/aci.o Godeps/_workspace/src/github.com/appc/spec/schema.o  Godeps/_workspace/src/github.com/cznic/ql.o Godeps/_workspace/src/github.com/cznic/mathutil.o  Godeps/_workspace/src/golang.org/x/crypto/openpgp.o Godeps/_workspace/src/code.google.com/p/go-uuid/uuid.o Godeps/_workspace/src/github.com/cznic/mathutil/example.o Godeps/_workspace/src/golang.org/x/net/html.o  ./networking/ipam/static/backend/disk.o ./pkg/keystore/keystoretest.o Godeps/_workspace/src/github.com/appc/docker2aci/tarball.o Godeps/_workspace/src/github.com/cznic/ql/design.o 
